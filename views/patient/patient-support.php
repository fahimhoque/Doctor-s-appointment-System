...
<body class="dark-scheme">
    <div id="wrap">
        <div id="main" class="container">
            <h1>DAS-Patient Support</h1>

            <div style="font-size:10pt">Welcome, <?php echo  $user_fname." # ".$user_id;?> </div>

            <div class="col col-md-4" style="margin-left: -15px;">
			   	<i class="fas fa-home icon" style="margin-right: 10px"></i><a href="patient-dashboard">Back to home</a>
			</div>
